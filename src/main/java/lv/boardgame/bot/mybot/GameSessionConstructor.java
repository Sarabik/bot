...
public class GameSessionConstructor {
	...
	public void setBotState(String username, BotState state) {
		getGameSessionByUsername(username).setBotState(state);
	}
	...
	public void start(String username) {
		...
		constructorMap.put(username, new GameSessionBotStatePair(gs, BotState.START));
	}
